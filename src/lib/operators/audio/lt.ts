...
export const lt: Operator = {
    definition: {
        ...
        description: 'Creates a low tom synth node. If a gate signal is on the stack, it is used for triggering. Otherwise, the sound is triggered once immediately.',
        example: "lt play   # Single hit\n2 impulse lt play # Repeating hit",
